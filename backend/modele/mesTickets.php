...
try {
    ...
    $sql = "
       SELECT t.idTicket, t.titre, t.description, t.statut, t.priorite, t.dateCreation, t.categorie, t.idTechnicien, t.sousCategorie, u.nomUtilisateur, u.prenomUtilisateur FROM ticket t LEFT JOIN partagerTicket pt ON pt.idTicket = t.idTicket JOIN utilisateur u ON t.idUtilisateur = u.idUtilisateur WHERE (t.idTechnicien = :idTechnicien OR pt.idTechnicien = :idTechnicien) AND t.statut NOT IN ('resolu', 'ferme') ORDER BY t.dateCreation DESC;
    ";
